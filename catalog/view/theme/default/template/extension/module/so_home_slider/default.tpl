...
?>
	<div class="form-group">
		<?php echo html_entity_decode($pre_text, ENT_QUOTES, 'UTF-8');?>
	</div>
<?php
	}
?>
			...
			<?php foreach($list as $item){?>
				<div class="item ">
					...
					<div class="sohomeslider-description">
						<h2><?php echo html_entity_decode($item['caption'], ENT_QUOTES, 'UTF-8')?></h2>
						<?php echo html_entity_decode($item['description'], ENT_QUOTES, 'UTF-8')?>
					</div>
				</div>
			<?php }?>
		</div>
...
?>
	<div class="form-group">
		<?php echo html_entity_decode($post_text, ENT_QUOTES, 'UTF-8');?>
	</div>
<?php
}
?>
