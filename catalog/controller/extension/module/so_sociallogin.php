...
class ControllerExtensionModuleSoSociallogin extends Controller {
	...
	public function Linkedin() {
		...
		$setting = $this->model_setting_setting->getSetting('so_sociallogin');
			...
			$app_id = $setting['so_sociallogin_linkdinapikey'];
			$app_secret = $setting['so_sociallogin_linkdinsecretapi'];
			$callback = $this->url->link('extension/module/so_sociallogin/CallBackLinkedin', '', 'SSL');
	...
	public function CallBackLinkedin() {
		...
		$user = new stdClass();
		$user->emailAddress = $emailObject->elements[0]->{"handle~"}->emailAddress;
     
		$user->firstName = isset($profileObject->firstName->localized->zh_CN) ? $profileObject->firstName->localized->zh_CN : $profileObject->firstName->localized->en_US;
		$user->lastName = isset($profileObject->lastName->localized->zh_CN) ? $profileObject->lastName->localized->zh_CN : $profileObject->lastName->localized->en_US;
